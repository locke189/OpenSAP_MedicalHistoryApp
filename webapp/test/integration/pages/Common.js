sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("demo_app/com/app", ".html");
		...
		return Opa5.extend("demo_app.com.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["demo_app/com/localService/mockserver"], function (mockserver) {
